<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li
            class="menu-item {{ isActiveRoute(['admin.category.index', 'admin.category.create', 'admin.category.edit']) }}">
        ...
        <li
            class="menu-item {{ isActiveRoute(['admin.service.index', 'admin.service.create', 'admin.service.edit']) }}">
